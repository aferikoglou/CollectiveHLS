...
parser.add_argument('--VITIS_OPTIMIZATIONS_ENABLED', type=utils.str2bool, default=False, help='Specifies whether to enable the default Vitis optimizations.')
parser.add_argument('--REPROPOSE_DIRECTIVES', type=utils.str2bool, default=False, help='Indicates whether to reapply directives if the generated solution is not feasible.')
...
REPROPOSE_DIRECTIVES        = args.REPROPOSE_DIRECTIVES
